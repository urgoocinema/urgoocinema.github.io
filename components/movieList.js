...
export class MovieList extends HTMLElement {
  ...
  onTimeSelected(e) {
    console.log('onTimeSelected called with:', e.detail);
    ...
    // Use the router to navigate instead of window.location
    import('./Router.js').then(({ Router }) => {
      console.log('Router imported, calling navigate...');
      Router.navigate('/seat-selection', queryParams);
    }).catch(error => {
